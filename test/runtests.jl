...
@test begin
    pt_upsampled = caplab_zbc2014.upsample(pt, 5)
...
@testset "C bindings: check callable" begin
  ...
  @test begin
      ...
      caplab_zbc2014.IHCAN!(px, cf, nrep, tdres, totalstim, cohc, cihc, species, ihcout, c1out, c2out)
      true
  end
  ...
  @test begin
      ...
      caplab_zbc2014.IHCAN!(px, cf, nrep, tdres, totalstim, cohc, cihc, species, ihcout, c1out, c2out)
      caplab_zbc2014.Synapse!(ihcout, ffGn, tdres, cf, totalstim, nrep, spont, noiseType, implnt,
                       sampFreq, synouttmp)
      true
  end
  ...
  @test begin
      ...
      caplab_zbc2014.IHCAN!(px, cf, nrep, tdres, totalstim, cohc, cihc, species, ihcout, c1out, c2out)
      caplab_zbc2014.SingleAN!(ihcout, ffGn, cf, nrep, tdres, totalstim, fibertype, noiseType,
